...
class Dossier(Base):
    ...
    pieces:       Mapped[list["PieceJustificative"]] = relationship("PieceJustificative", back_populates="dossier", cascade="all, delete-orphan")
    historique:   Mapped[list["DossierHistorique"]]  = relationship("DossierHistorique",  back_populates="dossier", cascade="all, delete-orphan", order_by="DossierHistorique.created_at")
