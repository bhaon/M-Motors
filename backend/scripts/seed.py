...
VEHICLES_DATA = [
    dict(
        ...
        spec_carburant="Essence TCe 100",
        spec_boite="Manuelle 6v",
        spec_couleur="Rouge Flamme",
        spec_places=5,
        spec_puissance="100 ch",
        options=[
            ("Assurance tous risques", 39),
            ("Assistance dépannage", 9),
            ("Entretien & SAV", 29),
            ("Contrôle technique", 5),
        ],
    ),
    dict(
        make="Peugeot",
        ...
        year=2020,
        km=52000,
        moteur=MoteurEnum.diesel,
        prix=19500,
        lld=True,
        mensualite=269,
        img="https://images.unsplash.com/photo-1555215695-3004980ad54e?w=600&q=70",
        spec_carburant="BlueHDi 130",
        spec_boite="EAT8 automatique",
        spec_couleur="Gris Platinium",
        spec_places=5,
        spec_puissance="130 ch",
        options=[
    ...
    dict(
        ...
        spec_carburant="TSI 150 Essence",
        spec_boite="DSG7 automatique",
        spec_couleur="Bleu Atlantis",
        spec_places=5,
        spec_puissance="150 ch",
        options=[
            ("Assurance tous risques", 52),
            ("Assistance dépannage", 9),
            ("Entretien & SAV", 39),
            ("Contrôle technique", 5),
        ],
    ...
    dict(
        ...
        year=2021,
        km=33000,
        moteur=MoteurEnum.hybride,
        prix=16800,
        lld=False,
        mensualite=None,
        img="https://images.unsplash.com/photo-1571607388263-1044f9ea01dd?w=600&q=70",
        spec_carburant="Hybride 116 ch",
        spec_boite="CVT automatique",
        spec_couleur="Blanc Nacré",
        spec_places=5,
        spec_puissance="116 ch",
        options=[],
    ),
    dict(
        make="BMW",
        ...
        mensualite=419,
        img="https://images.unsplash.com/photo-1555215695-3004980ad54e?w=600&q=70",
        spec_carburant="Diesel 190 xDrive",
        spec_boite="Steptronic 8",
        spec_couleur="Noir Saphir",
        spec_places=5,
        spec_puissance="190 ch",
        options=[
            ("Assurance tous risques", 65),
            ("Assistance dépannage", 9),
            ("Entretien & SAV", 55),
            ("Contrôle technique", 5),
        ],
    ...
    dict(
        ...
        mensualite=229,
        img="https://images.unsplash.com/photo-1609521263047-f8f205293f24?w=600&q=70",
        spec_carburant="PureTech 130",
        spec_boite="EAT6 automatique",
        spec_couleur="Orange Copper",
        spec_places=5,
        spec_puissance="130 ch",
        options=[
            ("Assurance tous risques", 41),
            ("Assistance dépannage", 9),
            ("Entretien & SAV", 29),
            ("Contrôle technique", 5),
        ],
    ...
    dict(
        ...
        year=2022,
        km=22000,
        moteur=MoteurEnum.electrique,
        prix=38900,
        lld=True,
        mensualite=499,
        img="https://images.unsplash.com/photo-1551522435-a13afa10f103?w=600&q=70",
        spec_carburant="100% Électrique",
        spec_boite="Auto (1 vitesse)",
        spec_couleur="Blanc Perle",
        spec_places=5,
        spec_puissance="283 ch",
        options=[
            ("Assurance tous risques", 72),
            ("Assistance dépannage", 9),
            ("Entretien & SAV", 45),
            ("Contrôle technique", 5),
        ],
    ...
    dict(
        ...
        spec_carburant="EcoBlue 120 Diesel",
        spec_boite="Manuelle 6v",
        spec_couleur="Gris Magnétique",
        spec_places=5,
        spec_puissance="120 ch",
        options=[],
    ),
    dict(
        make="Mercedes",
        ...
        spec_carburant="EQ Boost 163 ch",
        spec_boite="DCT7 automatique",
        spec_couleur="Blanc Polaire",
        spec_places=5,
        spec_puissance="163 ch",
        options=[
            ("Assurance tous risques", 58),
            ("Assistance dépannage", 9),
            ("Entretien & SAV", 49),
            ("Contrôle technique", 5),
        ],
    ...
    dict(
        ...
        mensualite=None,
        img="https://images.unsplash.com/photo-1609521263047-f8f205293f24?w=600&q=70",
        spec_carburant="TCe 90 Essence",
        spec_boite="Manuelle 5v",
        spec_couleur="Vert Komodo",
        spec_places=5,
    ...
    dict(
        ...
        spec_carburant="TFSI 150 Essence",
        spec_boite="S-Tronic 7",
        spec_couleur="Gris Daytona",
        spec_places=5,
        spec_puissance="150 ch",
        options=[
    ...
    dict(
        ...
        mensualite=379,
        img="https://images.unsplash.com/photo-1519641471654-76ce0107ad1b?w=600&q=70",
        spec_carburant="Hybride 48V 180 ch",
        spec_boite="DCT6 automatique",
        spec_couleur="Phantom Black",
        spec_places=5,
        spec_puissance="180 ch",
        options=[
            ("Assurance tous risques", 59),
            ("Assistance dépannage", 9),
            ("Entretien & SAV", 42),
            ("Contrôle technique", 5),
        ],
